...
class Cardmovies extends Component {
  ...
  render() {
    let content = this.state.loading ? <Spinner /> : <div className="cards">
    ...
    return (
      <div className='FL'>
        <div className='favorite-side'>
          <button className="favoriteicon">       {this.state.favoritecount} <FaHeart color='red' size='35' onClick={this.showModal} />
          </button>
