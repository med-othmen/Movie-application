    ...
    return <div className="Login">
      <Form className="form">
        ...
        <FormGroup >
          ...
          <Col sm={12}>
            <Input type="email" name="email" id="exampleEmail" value={this.state.mdp} placeholder="*************" bsSize="lg" onChange={this.verifpassword} />
          </Col>
        </FormGroup>
        <FormGroup >
          <Label for="exampleEmail" sm={10} >Url de votre image </Label>
          <Col sm={12}>
            <Input type="email" name="email" id="exampleEmail" placeholder="URL de votre image" onChange={this.handelchangeimg} bsSize="lg" />

          </Col>
        </FormGroup>
        </div>
        <div className="buttonssignup">
          <ButtonToggle color="danger" className="C" float="right" onClick={this.inscriptionvalidation}>S'inscrire</ButtonToggle>
          <Link to="/"> <ButtonToggle className="C" color="warning" onClick={this.cancelinscription}>Login</ButtonToggle></Link>
        </div>
